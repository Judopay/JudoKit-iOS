...
static NSString *const kAddressAdministrativeDivisionKey = @"address_administrative_division";
...
static NSString *const kRecommendationTimeoutKey = @"recommendation_timeout";
